...
Класс отвечает за хранение и управление каталогом товаров, полученных с сервера.
...
Класс отвечает за хранение товаров, добавленных пользователем в корзину, и за расчёт агрегированных данных.
...
Класс отвечает за хранение данных покупателя, вводимых при оформлении заказа, а также за их валидацию.
